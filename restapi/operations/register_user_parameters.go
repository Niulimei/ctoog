...
type RegisterUserParams struct {
	...
	/*用户信息
	  ...
	  In: body
	*/
	UserRegisterInfo *models.UserRegisterModel
}
...
func (o *RegisterUserParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		...
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("userRegisterInfo", "body", ""))
			} else {
				res = append(res, errors.NewParseError("userRegisterInfo", "body", "", err))
			}
		} else {
